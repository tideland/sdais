...
Read all RSF item files in sdais/rsf/v<N>/. Do not modify any RSF file.
...
After writing all finding files, output a summary listing each finding file
name, category, severity, and the first sentence of its description. Nothing
else. Do not ask for next steps.
--- END FILE ---
